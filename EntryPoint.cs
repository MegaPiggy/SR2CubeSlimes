...
namespace CubeSlimes
{
    public class EntryPoint : MelonMod
    {
        ...
        internal static Il2CppAssetBundle cubeslime = Il2CppAssetBundleManager.LoadFromMemory(GetAsset("cubeslime"));
        ...
        public static Mesh CubeMesh => cubeslime.Load<GameObject>("assets/cube_slime.obj").GetComponentInChildren<MeshFilter>().sharedMesh;
        ...
        public static Sprite ImageSprite(string name)
        {
            using (Stream manifestResourceStream = execAssembly.GetManifestResourceStream(name))
            {
                Texture2D texture = new Texture2D(4, 4);
                byte[] buffer = new byte[manifestResourceStream.Length];
                manifestResourceStream.Read(buffer, 0, (int)manifestResourceStream.Length);
                Il2CppImageConversionManager.LoadImage(texture, buffer);
